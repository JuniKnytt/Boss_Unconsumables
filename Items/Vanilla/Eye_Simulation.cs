...
{
	public class Eye_Simulation : ModItem
	{
		

		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Eye Simulation"); 
			Tooltip.SetDefault("Not consumable\nSummons The Twins Indefinitely.\nIt's a computerized simulation of a mechanical eye.");
